...
Downloader::Downloader(const std::string& magnet_uri)
{
    ...
    for (;;) {
        ...
        for (lt::alert const* a : alerts) {
            ...
            if (auto st = lt::alert_cast<lt::state_update_alert>(a)) {
                ...
                std::cout << "\r" << StateString(s.state) << " "
...
const std::string Downloader::StateString(const lt::torrent_status::state_t s)
{
    switch (s) {
